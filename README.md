...
$$
\mathrm{current\_effort\_per\_1pct}(t)
=
...
$$
\mathrm{past\_avg\_effort\_per\_1pct}(t)
=
\frac{
\sum_{i=t-w}^{t-1} \mathrm{volume}(i)
}{
\sum_{i=t-w}^{t-1} \mathrm{abs\_move\_pct}(i)
}
$$
...
$$
\mathrm{low\_threshold}
\le
\mathrm{price\_score}(t)
\le
\mathrm{high\_threshold}
$$
